...
String strSql = "insert into marriage41( userid,marriageposition,mate,time) values(?,?,?,?)";
String s_xh = (String)session.getAttribute("pram_xh");
	...
	String driverName1 = "com.mysql.jdbc.Driver";
        ...
        sql.setString(2, request.getParameter("position"));
        sql.setString(3, request.getParameter("mate"));
