...
String password = "kamisama";
	...
	String a = request.getParameter("work");
	String strSql = "select count(*) from workpost41 where post='"+a+"' ;";
	String strSql1 = "select userid from workpost41 where post='"+a+"' ;";
	ResultSet rs,rs1;
	...
	out.print("	<tr><td>岗位</td><td>人数</td><td>员工工号</td></tr>");
	if(rs.next()){
	out.print("<tr>");
